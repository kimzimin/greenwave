...
function CheckList({navigation}) {
  ...
  return (<View style={styles.container}>
    ...
    <Text style={styles.text}>체크리스트</Text><AntDesign style={styles.plus} name="plus" size={25}/></View>
    ...
    <ScrollView>
        ...
        <TouchableOpacity onPress={() => doneToDo(key)} style={{...styles.toDo, backgroundColor: toDos[key].done ? "#CFE3D0" : "white" }} key={key} >
